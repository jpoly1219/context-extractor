import { get_state, get_songs } from "./prelude";
...
const PlayList_eq = (p1, p2) => {
    return (PlayListState_eq(get_state(p1), get_state(p2)) &&
        get_songs(p1).length === get_songs(p2).length &&
        get_songs(p1).every((id, i) => id === get_songs(p2)[i]));
};
// Testing PlaySong
const test1 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "NoSongSelected" }], { type: "PlaySong", id: 0 }), [[0, 1, 2], { type: "Playing", id: 0 }]),
    values: [
...
const test2 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "PausedOn", id: 1 }], { type: "PlaySong", id: 1 }), [[0, 1, 2], { type: "Playing", id: 1 }]),
    values: [
...
const test3 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "PausedOn", id: 0 }], { type: "PlaySong", id: 1 }), [[0, 1, 2], { type: "Playing", id: 1 }]),
    values: [
...
const test4 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "NoSongSelected" }], { type: "PauseCurrentSong" }), [[0, 1, 2], { type: "NoSongSelected" }]),
    values: [
...
const test5 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "PausedOn", id: 1 }], { type: "PauseCurrentSong" }), [[0, 1, 2], { type: "PausedOn", id: 1 }]),
    values: [
...
const test6 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "Playing", id: 0 }], { type: "PauseCurrentSong" }), [[0, 1, 2], { type: "PausedOn", id: 0 }]),
    values: [
...
// Testing RemoveSong
const test7 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "NoSongSelected" }], { type: "RemoveSong", id: 0 }), [[1, 2], { type: "NoSongSelected" }]),
    values: [
...
const test8 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "Playing", id: 0 }], { type: "RemoveSong", id: 0 }), [[1, 2], { type: "NoSongSelected" }]),
    values: [
...
const test9 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "PausedOn", id: 0 }], { type: "RemoveSong", id: 0 }), [[1, 2], { type: "NoSongSelected" }]),
    values: [
...
const test10 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "Playing", id: 1 }], { type: "RemoveSong", id: 0 }), [[1, 2], { type: "Playing", id: 1 }]),
    values: [
...
const test11 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "PausedOn", id: 1 }], { type: "RemoveSong", id: 0 }), [[1, 2], { type: "PausedOn", id: 1 }]),
    values: [
...
const test12 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "Playing", id: 1 }], { type: "RemoveSong", id: 3 }), [[0, 1, 2], { type: "Playing", id: 1 }]),
    values: [
...
// Testing AddSong
const test13 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "NoSongSelected" }], { type: "AddSong", id: 3 }), [[0, 1, 2, 3], { type: "NoSongSelected" }]),
    values: [
...
const test14 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "Playing", id: 0 }], { type: "AddSong", id: 3 }), [[0, 1, 2, 3], { type: "Playing", id: 0 }]),
    values: [
...
const test15 = () => ({
    result: PlayList_eq(update([[0, 1, 2], { type: "PausedOn", id: 0 }], { type: "AddSong", id: 3 }), [[0, 1, 2, 3], { type: "PausedOn", id: 0 }]),
    values: [
