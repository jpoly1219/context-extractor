...
const outDirRoot = path.join(projectRoot, "vector-retrieval", "out", runID);
...
// TODO: create the test suite by combining dir-specific prelude, completed sketch, and epilogue
