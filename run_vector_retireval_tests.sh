...
# Constants
command_prefix="node --env-file=.env src/vector-retrieval.mjs"
# api_key="--api-key $HOME/azure-4-api-key.txt"
# api_key="--api-key /home/jacob/projects/testtslspclient/openai-key.txt"
run_name=${1:-default}
projectRoot=$(pwd)
log_directory="$projectRoot/vector-retrieval/testlog/"
collate_script="$projectRoot/vector_collate_data.sh"
